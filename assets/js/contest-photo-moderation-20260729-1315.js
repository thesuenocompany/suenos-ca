    ...
    panel.innerHTML = `
      ...
      <div class="contest-photo-review-grid">
        ${photos.map(entry => {
          ...
          const birthDate = entry.birth_date ? new Date(`${entry.birth_date}T00:00:00`).toLocaleDateString('en-CA',{year:'numeric',month:'long',day:'numeric'}) : 'Not recorded';
            ...
            <article class="contest-photo-review-card is-${esc(galleryStatus)}" data-review-card="${esc(entry.id)}">
              ...
              <div class="contest-photo-review-body">
                ...
                <dl>
                  ...
                  <div><dt>Date of birth</dt><dd>${esc(birthDate)}</dd></div>
